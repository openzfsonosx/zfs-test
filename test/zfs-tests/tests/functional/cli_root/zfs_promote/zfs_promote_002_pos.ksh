...
log_must $MKFILE $MKFILE_SPARSE $FILESIZE $TESTDIR/$TESTFILE0
log_must $ZFS snapshot $snap
log_must $MKFILE $MKFILE_SPARSE $FILESIZE $TESTDIR/$TESTFILE1
log_must $RM -f $testdir/$TESTFILE0
log_must $ZFS snapshot $snap1
log_must $ZFS clone $snap1 $clone
log_must $MKFILE $MKFILE_SPARSE $FILESIZE /$clone/$CLONEFILE
