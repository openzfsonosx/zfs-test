...
log_mustnot $MKFILE $MKFILE_SPARSE 11M $mntpnt/file
log_must $MKFILE $MKFILE_SPARSE 9M $mntpnt/file
log_must $ZFS snapshot $fs@snap
log_mustnot $MKFILE $MKFILE_SPARSE 2M $mntpnt/file2

mntpnt=$(get_prop mountpoint $sub)
log_must $MKFILE $MKFILE_SPARSE 10M $mntpnt/file
log_must $ZFS snapshot $sub@snap
log_must $MKFILE $MKFILE_SPARSE 10 $mntpnt/file2
